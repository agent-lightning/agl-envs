...
with open(
    "agl_envs/task_data/scienceworld/split_sets/variations_idx/seen_variants_seen_tasks.json", "r"
) as f:
    data = json.load(f)
with open("agl_envs/task_data/scienceworld/split_sets/id2taskname.json", "r") as f:
    id2taskname = json.load(f)

output_dir = "agl_envs/task_data/scienceworld/multi_data"
