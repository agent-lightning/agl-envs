...
def make_env(env_name, task, config):
    ...
    if env_name == "scienceworld":
        from agl_envs.scienceworld.scienceworld_env import make_scienceworld_env
        return make_scienceworld_env(env_name, task, config)

    elif env_name == "alfworld":
        from agl_envs.alfworld.alfworld_env import make_alfworld_env
...
def make_env_manager(env_name, task, config):
    ...
    from agl_envs.env_manager import EnvironmentManager
