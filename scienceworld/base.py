...
import numpy as np
from agl_envs.utils import extract_pure_action, extract_reasoning
...
class SciWorldEnv(ABC):
    ...
    def set_max_steps(self, sub_task_name):
        ...
        self.max_steps_dict = json.load(open("agl_envs/task_data/scienceworld/split_sets/max_steps.json"))
