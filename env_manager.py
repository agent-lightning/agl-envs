class EnvironmentManager:
    ...
    def get_instruction_prompt(self):
        env_map = {
            "scienceworld": ("agl_envs.scienceworld", {"env": self.env, "mission": self.mission}),
        }
    ...
    def get_single_prompt_template(self):
        if self.env_name == "scienceworld":
            from agl_envs.scienceworld import get_single_prompt_template

            return get_single_prompt_template(self.mission)

        elif self.env_name == "alfworld":
            from agl_envs.alfworld import get_single_prompt_template
